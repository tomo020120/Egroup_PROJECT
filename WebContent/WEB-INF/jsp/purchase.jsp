...
<body>
	...
	<c:forEach var="deliveryInfo" items="${result}">
		<div class="deliveryInfo">
			...
			<a href="deleteDeliveryInfoForm?deliveryInfoId=${deliveryInfo.deliveryInfoId}">決定</a>
		</div>
	</c:forEach>
	<h1>新規配送先登録</h1>
	<div id="deliveryFormArea">
		<form id="registDeliveryInfoForm" class="h-adr" method="post" action="addDelivery" >
			...
			【必須】住所:<input type="text" class="p-region p-locality p-street-address p-extended-address" name="address" readOnly/><br>
